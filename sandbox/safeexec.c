...
struct config profile = { 10, 32768, 0, 8192, 1024, 0, 60,
			  512, 16, 
			  1000, 10000, 0, 0,
			  NULL, NULL, NULL, NULL };
...
enum{ ole_code = 32,      mle_code = 33,
      tle_code = 34,      rtle_code = 35,
      rf_code = 36,       ie_code = 37,
      retnz_code = 38,    term_code = 39
  }; /* 0-31 reserved code for internal error */
